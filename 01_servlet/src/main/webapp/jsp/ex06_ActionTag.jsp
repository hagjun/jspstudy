...
<%-- <% request.setAttribute("phone", "010-0000-0000"); %>
 	<h2>include 지시어 사용하기</h2>
 	<%@ include file="ex05_pageContext.jsp" %> <!-- 호출한 후 값을 저장하면 결과값이 안나옴 --> --%> 
