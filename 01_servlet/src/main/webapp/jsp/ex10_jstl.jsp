...
<body>
	...
	<h3>
		...
		<!-- 시간 날짜 둘다 사용시 both 사용 -->
		<li><fmt:formatDate value="${now}" dateStyle="short" type="both" timeStyle="short"/></li>		
		<li><fmt:formatDate value="${now}" dateStyle="medium" type="both" timeStyle="medium"/></li>		
		<li><fmt:formatDate value="${now}" dateStyle="long" type="both" timeStyle="long"/></li>		
		<li><fmt:formatDate value="${now}" dateStyle="full" type="both" timeStyle="full"/></li>
		<hr>		
