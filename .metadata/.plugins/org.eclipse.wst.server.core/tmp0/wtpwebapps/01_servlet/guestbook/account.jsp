		...
		<form method="post">
			<table>
				...
				<tr align="center">
					...
					<td><input type="text" name="addr" size ="20" value="${mvo.addr}"/></td>
				</tr>
				<tr align="center">
					<td bgcolor="#99ccff">핸드폰 번호</td>
					<td><input type="text" name="phone" size ="20" value="${mvo.phone}"/></td>
				</tr>
				<tfoot>
					<tr align="center">
						<td colspan="2">
							<input type="hidden" name="cmd" value="account_ok">
							<input type="button" value="회원가입"   onclick="account_go(this.form)" />
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
